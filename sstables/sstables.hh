...
public:
    ...
    gc_clock::time_point get_gc_before_for_drop_estimation(const gc_clock::time_point& query_time) const;
    gc_clock::time_point get_gc_before_for_fully_expire(const gc_clock::time_point& query_time) const;
};
