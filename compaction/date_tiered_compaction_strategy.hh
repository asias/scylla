...
public:
    ...
    get_next_sstables(table_state& table_s, std::vector<sstables::shared_sstable>& uncompacting, gc_clock::time_point query_time);

    int64_t get_estimated_tasks(table_state& table_s) const;
private:
    std::vector<sstables::shared_sstable>
    get_next_non_expired_sstables(table_state& table_s, std::vector<sstables::shared_sstable>& non_expiring_sstables, gc_clock::time_point query_time);
